		...
		<form action="<?php echo $commentURL->getInsertURL()?>" method="post" id="kboard_comments_form" onsubmit="return kboard_comments_execute(this);">
			...
			<div class="kboard-comments-form">
				...
				<div class="comments-username">
					<label class="comments-username-label" for="comments_member_display"><?php echo __('Author', 'kboard-comments')?></label> <input type="text" id="comments_member_display" name="member_display" value="<?php echo $userdata->data->display_name?>">
				</div>

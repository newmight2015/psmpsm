	...
	while( $ml_query->have_posts() ) :
		...
		$html .= ob_get_clean() .'>';
			...
			$html.= '<div class="post-content">';
				...
				if($atts['meta_all'] && $atts['meta_tags'] && ($atts['layout'] == 'large' || $atts['layout'] == 'medium' || $atts['layout'] == 'grid' || $atts['layout'] == 'timeline')) {
					ob_start();
					the_tags( );
					$html .= '<div class="meta-tags bottom">' . ob_get_clean() . '</div>';
				}
